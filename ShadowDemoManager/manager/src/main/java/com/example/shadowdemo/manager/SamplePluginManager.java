package com.example.shadowdemo.manager;
...
import com.example.shadowdemo.plugin.IMyAidlInterface;
...
public class SamplePluginManager extends FastPluginManager {
    ...
    protected String getPluginProcessServiceName() {
        return "com.example.shadowdemo.introduce_shadow_lib.MainPluginProcessService";
    }
    ...
    public void enter(final Context context, long fromId, Bundle bundle, final EnterCallback callback) {
        if (fromId == Constant.FROM_ID_START_ACTIVITY) {
            ...
            bundle.putString(Constant.KEY_ACTIVITY_CLASSNAME, "com.example.shadowdemo.plugin.MainActivity");
    ...
    private void callPluginService(final Context context) {
        ...
        final String className = "com.example.shadowdemo.plugin.MyService";
