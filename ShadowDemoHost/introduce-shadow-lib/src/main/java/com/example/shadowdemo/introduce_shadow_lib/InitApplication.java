package com.example.shadowdemo.introduce_shadow_lib;
...
public class InitApplication {
    ...
    public static void onApplicationCreate(Application application) {
        ...
        FixedPathPmUpdater fixedPathPmUpdater = new FixedPathPmUpdater(new File("/data/local/tmp/manager-debug.apk"));
